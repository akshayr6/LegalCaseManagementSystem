...
$sql = "INSERT INTO CASES (id,lawyer_id,client_id,judge_id,type,name) VALUES ('$case_id','$lawyer','$client','$judgeid','$type','$case_name')";
$value = mysqli_query($conn,$sql);
...
<div class="container">
    ...
    <label class="control-label col-xs-4">Judge ID:</label> <div class="col-xs-8"><input name = 'judge_id' type = 'text'><br />
	</div></div><div class='form-group'>
